...
window.onscroll = function () {
  this.scrollY >= 1 ? toTop.classList.add("active") : toTop.classList.remove("active");
};
...
function addedToCart(id) {
  // Find the chosen item from the products array
...
function updateCartUI() {
  ...
  // Update the cart UI with the items and their quantities
